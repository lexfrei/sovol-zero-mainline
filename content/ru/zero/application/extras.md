...
Ставится без разборки принтера. Кабель стокового датчика филамента залит компаундом в порту на материнке — чтобы его выдернуть, придётся разбирать принтер и отколупывать компаунд с порта. Не надо: оставь стоковый кабель воткнутым, сними с него только сам датчик, а свободный конец зафиксируй комплектными стяжками. Новый кабель SFS просунь через боковое окошко камеры и посади на два соседних свободных порта (`PE7` + `PE8` ниже), не трогая залитый стоковый порт.
