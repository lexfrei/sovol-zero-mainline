...
`TEST_RESONANCES` — чанкованное FIFO-чтение LIS2DW на mainline даёт чистую трассу, и с широким окном `[resonance_tester]` (а не с вендорскими запиненными 35–45 Гц) всплывает реальный резонанс. На этом хосте диагональному тесту нужна остановленная камера — смотри [troubleshooting]({{< relref "/zero/troubleshooting" >}}).
