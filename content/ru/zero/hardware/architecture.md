...
> [!WARNING]
> **Проверь медную втулку в хотэнде.** Старые ревизии хотэнда шли без медной втулки, и они до сих пор попадаются — в карточке товара втулка есть, а в самом юните может не быть. Без неё радиатор не снимает тепло с хитбрейка: радиатор не работает вообще, термопаста не спасает, ловишь тепловой пробой и пробки. Sovol меняет такой хотэнд бесплатно — проверь свой, прежде чем гоняться за призрачной проблемой экструзии. Это общий тулхед Zero/SV08 Max, так что касается обоих.
