...
- Even *replacing* Katapult itself doesn't strictly need SWD: a Katapult **deployer** (build it from source — see [BUILD.md](BUILD.md)) flashed through the stock bootloader over USB installs mainline Katapult in place. SWD stays the recovery path for a bootloader that is already corrupt.
